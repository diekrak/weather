...
INSERT INTO `metric` VALUES (1,NULL,'Temperature'),(2,NULL,'wind speed');
...
CREATE TABLE `sensor_reading` (
  ...
  PRIMARY KEY (`id`),
  KEY `index1` (`sensor_id`,`metric_id`,`date`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;


drop user if exists 'gen'@'%';
CREATE USER if not exists 'gen'@'%' IDENTIFIED BY 'admin';
